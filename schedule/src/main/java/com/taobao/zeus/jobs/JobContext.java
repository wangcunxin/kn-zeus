...
public class JobContext {
	...
	public static JobContext getTempJobContext(){
		...
		File f=new File("/data1/dispatch/data/mFile/"+DateUtil.getToday());
//		File f=new File("/data/zeus/tmp/"+DateUtil.getToday());
//		File f=new File("/home/hadoop/zeus/tmp/"+DateUtil.getToday());
