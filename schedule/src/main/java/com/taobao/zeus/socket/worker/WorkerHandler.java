...
public class WorkerHandler extends SimpleChannelUpstreamHandler{
			...
			public void run() {
				while(true){
					try {
                        ...
                        // SocketLog.info("#### WorkHandler #### run");
						Response resp=f.get();
						if(context.getServerChannel()!=null){
                            // SocketLog.info("#### WorkHandler #### context.getServerChannel() :" + context.getServerChannel());
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
		...
		// SocketLog.info("#### WorkHandler #### messageReceived : sm.getKind():" + sm.getKind());
