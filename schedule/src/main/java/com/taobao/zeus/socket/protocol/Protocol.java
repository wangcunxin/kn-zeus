...
public final class Protocol {
  ...
  public static final class HeartBeatMessage extends
    ...
    // optional float cpuLoadPerCore = 7;
    public static final int CPULOADPERCORE_FIELD_NUMBER = 7;
    private boolean hasCpuLoadPerCore;
    private float cpuLoadPerCore_ = 0F;
    public boolean hasCpuLoadPerCore() { return hasCpuLoadPerCore; }
    public float getCpuLoadPerCore() { return cpuLoadPerCore_; }
    
    // optional float netRate = 8;
    public static final int NETRATE_FIELD_NUMBER = 8;
    private boolean hasNetRate;
    private float netRate_ = 0F;
    public boolean hasNetRate() { return hasNetRate; }
    public float getNetRate() { return netRate_; }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (hasCpuLoadPerCore()) {
        output.writeFloat(7, getCpuLoadPerCore());
      }
      if (hasNetRate()) {
        output.writeFloat(8, getNetRate());
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (hasCpuLoadPerCore()) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(7, getCpuLoadPerCore());
      }
      if (hasNetRate()) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(8, getNetRate());
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 61: {
              setCpuLoadPerCore(input.readFloat());
              break;
            }
            case 69: {
              setNetRate(input.readFloat());
              break;
            }
          }
        }
  ...
  result.hasHost = true;
      ...
      public boolean hasCpuLoadPerCore() {
        return result.hasCpuLoadPerCore();
      }
      public float getCpuLoadPerCore() {
        return result.getCpuLoadPerCore();
      }
      public Builder setCpuLoadPerCore(float value) {
        result.hasCpuLoadPerCore = true;
        result.cpuLoadPerCore_ = value;
        return this;
      }
      public Builder clearCpuLoadPerCore() {
        result.hasCpuLoadPerCore = false;
        result.cpuLoadPerCore_ = 0F;
        return this;
      }
      
      // optional float netRate = 8;
      public boolean hasNetRate() {
        return result.hasNetRate();
      }
      public float getNetRate() {
        return result.getNetRate();
      }
      public Builder setNetRate(float value) {
        result.hasNetRate = true;
        result.netRate_ = value;
        return this;
      }
      public Builder clearNetRate() {
        result.hasNetRate = false;
        result.netRate_ = 0F;
        return this;
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\021\n\terrorText\030\004 \001(\t\022\014\n\004body\030\005 \001(\014\"\257\001\n\020Hea" +
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_com_taobao_zeus_socket_protocol_HeartBeatMessage_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_com_taobao_zeus_socket_protocol_HeartBeatMessage_descriptor,
              new java.lang.String[] { "Runnings", "DebugRunnings", "ManualRunnings", "Timestamp", "MemRate", "Host", "CpuLoadPerCore", "NetRate", },
