...
public class JobDescriptor implements Serializable {
	...
	public JobDescriptor getCopy() {
		...
		jobDescriptor.setMailReceivers(this.getMailReceivers());
		jobDescriptor.setMailCc(this.getMailCc());
		jobDescriptor.setMailSubject(this.getMailSubject());
		jobDescriptor.setMailAttaches(this.getMailAttaches());
		jobDescriptor.setMailContent(this.getMailContent());
		jobDescriptor.setResponsibleMail(this.getResponsibleMail());
		jobDescriptor.setTaskId(this.getTaskId());
